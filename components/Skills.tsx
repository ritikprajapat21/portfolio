            ...
            <>
              <Tooltip key={tech.name}>
                <TooltipTrigger asChild key={tech.name}>
                  <Card className="flex justify-center p-2 items-center bg-gradient-to-tl from-blue-600 via-purple-600 to-indigo-300 transition-transform duration-300 hover:scale-110 hover:shadow-lg">
                    <Image
                      src={tech.icon}
                      width={100}
                      height={100}
